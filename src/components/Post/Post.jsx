...
const Post = ({ type, heading, content, profileImage, profileName, image }) => {
  return (
    <div className="card shadow-sm mb-4">
      <img src={image} alt="Nature" className="card-img-top" />
      <div className="card-body">
        <h3 className="card-title">{type}</h3>
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h4 className="card-subtitle mb-2">{heading}</h4>
